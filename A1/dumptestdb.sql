...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertUserData`(IN name varchar(50),IN address varchar(50),IN phone_number varchar(10))
BEGIN
    insert into TUserDetails (Name,Address,Phone_Number) values (name ,address,phone_number);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2016-05-25 21:39:46
